	...
	public void checkrazorpayopen() throws InterruptedException {
	    try {
	        ...
	        wait.until(ExpectedConditions.elementToBeClickable(
	                By.xpath("//input[@placeholder='Enter coupon code...']"))).sendKeys("t7fnlx");

	        WebElement applyOnCouponCode = wait.until(
	                ExpectedConditions.elementToBeClickable(By.xpath("//button[@class='apply-button']")));
	        applyOnCouponCode.click();
	        Thread.sleep(4000);
	        ...
	        String checkCouponCodeApply = wait.until(ExpectedConditions.elementToBeClickable(
	                By.xpath("//span[@class='error-message']"))).getText();
	        ...
	        WebElement clickOnRazorpayButton = wait.until(
	                ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='text']")));
